...
const handleLoginApi = (userEmail, userPassword) => {
    return axios.post('http://https://react-crud-kc0l.onrender.com/api/login', {Email: userEmail, password: userPassword});
}

const handleRegisterApi = (userEmail, userFName, userLName, userGender, userDob, userPhone, userPassword) => {
    return axios.post('http://https://react-crud-kc0l.onrender.com/api/register', {Email: userEmail, FirstName: userFName, LastName: userLName, Gender: userGender, Dob: userDob, Tel: userPhone, password: userPassword});
}

const handleEditProfileApi = (userID, FirstName, LastName, Tel, Dob, Gender, Email) => {
    return axios.put('http://https://react-crud-kc0l.onrender.com/api/user/profile/edit', 
...
const handleEditAddress = (userID, addrID, addrName, address, name, tel, isDefault) => {
    return axios.put('http://https://react-crud-kc0l.onrender.com/api/user/address/edit', 
...
const handleAddAddress = (userID, addrName, address, name, tel, isDefault) => {
    return axios.post('http://https://react-crud-kc0l.onrender.com/api/user/address/add', 
