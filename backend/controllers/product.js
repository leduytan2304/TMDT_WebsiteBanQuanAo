...
export const getImageSPM = (req,res)=>{
  const q = "SELECT * FROM Product PD, Images IM where PD.ProductID = IM.ProductID and PD.CategoryID = 'CAT005';";
...
export const getImageSS = (req,res)=>{
  const q = "SELECT * FROM Product PD, Images IM where PD.ProductID = IM.ProductID and PD.CategoryID = 'CAT004';";
