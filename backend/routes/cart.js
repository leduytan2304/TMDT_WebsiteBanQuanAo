...
import { getTotalPriceShopingCart,addProductToCart,removeProductFromCart, deleteProductFromCart,completedPayment,createOrder,getUserAddress, refundMoney,createOrderPayPal} from "../controllers/cart.js";
...
router.post("/createOrderPayPal/:userID",createOrderPayPal)//thêm sản phẩm vào giỏ hàng bên trong giỏ hàng
